...
import { getCapabilities, type EditorTheme, type MarkdownTheme, type SelectListTheme, type SettingsListTheme } from "@earendil-works/pi-tui";
import chalk from "chalk";
import { highlight, supportsLanguage } from "../utils/syntax-highlight.ts";
type ColorValue = string | number;
type ThemeJson = { name: string; vars?: Record<string, ColorValue>; colors: Record<ThemeColor | ThemeBg, ColorValue> };
